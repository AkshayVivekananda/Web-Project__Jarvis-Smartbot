...
def amazon(order):
    try:
        ...
        query = order
        speak("I am sorry,but i didnt get that.Please tell the exact words to search on amazon")
        web = "https://www.amazon.com/s?k=" + query
        webbrowser.open(web)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # ------------------------------ DEFAULT FUNCTIONS -----------------------------------------#
               ...
               speak("I am sorry to say that I cannot perform that. Please give me another command boss. You can tell exit to terminate my services")
